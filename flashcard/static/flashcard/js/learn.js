...
function playLearn(cards, my_question) {
console.log("question: " + my_question);
    ...
    $('#word-container').html(get_question());
...
function get_question() {
    if (question == 'front') {
        return current_cards[current_index]['fields']['front'];
    }
    else {
        return current_cards[current_index]['fields']['back'];
    }
